    ...
    <div class="container">
        ...
        <form method="POST" class="schedule-form">
            ...
            ?>
                <div class="day-row">
                    <label>
                        <input type="checkbox" name="day_of_week[]" value="<?php echo $day; ?>" <?php if ($startTime) echo 'checked'; ?>>
                        <?php echo $day; ?>
                    </label>
                    <input type="time" name="start_time[]" value="<?php echo $startTime; ?>" <?php if (!$startTime) echo 'disabled'; ?> placeholder="Start Time">
                    <input type="time" name="end_time[]" value="<?php echo $endTime; ?>" <?php if (!$endTime) echo 'disabled'; ?> placeholder="End Time">
                </div>
            <?php endforeach; ?>
