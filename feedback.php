...
//            <button type="submit" name="feedback" value="down">👎</button>
            ...
            <input type="image" name="feedback" value="4" src="assets/pics/semihappy.png" alt="Satisfied (4)">
            <input type="image" name="feedback" value="5" src="assets/pics/Good.png" alt="Very Satisfied (5)">
        </div>
    </form>
</div>
